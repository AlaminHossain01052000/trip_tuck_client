...
const Login = () => {
    ...
    console.log(user);
    const googleLogIn = () => {
        handleGoogleSignIn().catch(error => setError(true))
            .then(result => {
                if (result) {
